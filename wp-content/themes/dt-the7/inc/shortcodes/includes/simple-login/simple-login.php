	...
	class DT_Shortcode_Simple_Login extends DT_Shortcode {
		...
		protected function get_wp_login_form( $args = array() ) {
			$defaults = array(
				...
				'form_id' => 'loginform',
				'label_username' => _x( 'Username', 'shortcode simple login', LANGUAGE_ZONE ),
				'label_password' => _x( 'Password', 'shortcode simple login', LANGUAGE_ZONE ),
				'label_remember' => _x( 'Remember Me', 'shortcode simple login', LANGUAGE_ZONE ),
				'label_log_in' => _x( 'Log In', 'shortcode simple login', LANGUAGE_ZONE ),
				'id_username' => 'user_login',
				'id_password' => 'user_pass',
				'id_remember' => 'rememberme',
				'id_submit' => 'wp-submit',
			...
			if ( is_user_logged_in() ) {
				...
				$form = '<p class="logged-in-as">' 
					. sprintf(
						_x( 'Logged in as <a href="%1$s">%2$s</a>. <a href="%3$s" title="Log out of this account">Log out?</a>', 'shortcode simple login', LANGUAGE_ZONE ),
						get_edit_user_link(),
						$user_identity,
